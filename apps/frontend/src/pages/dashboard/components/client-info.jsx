...
export const ClientInfo = ({ client }) => {
  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <IconWithLabel label="Email" icon={EmailIcon} />
              </IconButton>
            </Container>
            <Container
              sx={{
            ...
            >
              ...
              >
                ...
                >
                  <IconWithLabel label="Call" icon={CallIcon} />
                </IconButton>
              </Tooltip>
            </Container>
          </Container>
      ...
      >
        <InfoItem fieldName="Status" fieldValue={client ? client.status : ''} />
        <InfoItem fieldName="Sector" fieldValue={client ? client.sector : ''} />
        <InfoItem fieldName="Company" fieldValue={client ? client.name : ''} />
        <InfoItem fieldName="Contact" fieldValue={client ? client.phone : ''} />
      </Container>
    </Container>
  );
};
